...
// Baseline endpoint: bypass analyzeSearchIntent (clarify/reject layers).
// Chỉ retrieve Top 20 candidates rồi chạy Gemini rerank.
// Dùng để đo lường baseline trước/sau khi thêm rule-based intent layer.
